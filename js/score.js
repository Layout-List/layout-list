...
export function score(rank, difficulty, percent, minPercent) {
    ...
    const exponent = 0.3; // the exponent of the exponential function ( level rank ^ (exponent + curveBuff) )
    const curveBuff = 1.0; // increase this value to increase the curve of the exponential function i think maybe, shoukd be greater than 0
