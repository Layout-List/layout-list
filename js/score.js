...
export function score(rank, difficulty, percent, minPercent) {
    ...
    const exponent = 1 // the exponent of the exponential function ( level rank ^ (exponent + curveBuff) )
    const curveBuff = 0.5 // increase this value to increase the curve of the exponential function i think maybe
