...
export default {
    ...
    template: `
        ...
        <router-link class="nav__cta type-label-lg" to="/challengeleaderboard">
            <span class="type-label-lg">Challenge List</span>
        </router-link>
        <main v-if="loading">
            <Spinner></Spinner>
        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        You must have achieved the record without using hacks (including hacks that change the physics of the game, ie. physics bypass via MegaHack, as well as clicks between frames).
                    </p>
                    <p>
