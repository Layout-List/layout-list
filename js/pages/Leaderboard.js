            ...
            <div v-else class="page-leaderboard">
                ...
                <div class="player-container">
                    <div class="player">
                        ...
                        <div v-for="pack in entry.userPacks" class="pack" :style="{ 'background': store.dark ? rgbaBind(entry.userPacks.dark) : rgbaBind(entry.userPacks.light) }" v-if="entry.userPacks !== undefined">{{ entry.userPacks.name }}</div>
